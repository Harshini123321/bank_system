...
thelabel_1=Label(window,width=90,height=40,bg="powder blue")
...
def mini_statement():
    ...
    new=results[0]
    balance=new[1]
    thelabel_11=Label(window,height=2,text=("Account Balance: "),font=("Courier New",18,"bold"),bg="powder blue")
    thelabel_11.place(x=600,y=500)
    
    thelabel_11=Label(window,height=2,text=balance,font=("Courier New",18,"bold"),bg="powder blue")
    thelabel_11.place(x=850,y=500)
